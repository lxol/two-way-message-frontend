...
class AccessibilityStatementViewSpec extends ViewBaseSpec {
  ...
  "The accessibility statement page" should {
    ...
    lazy val view = views.html.accessibility_statement(injector.instanceOf[FrontendAppConfig])
    ...
    "have an introduction section" which {
      ...
      "has a second paragraph" which {
        ...
        "has the correct link location" in {
          element("#introduction > p:nth-of-type(2) > a").attr("href") shouldBe "https://www.gov.uk/help/accessibility"
        }
      }
      ...
      "has a third paragraph" which {
        ...
        "has the correct link location" in {
          element("#introduction > p:nth-of-type(3) > a").attr("href") shouldBe "https://www.tax.service.gov.uk/vat-through-software/vat-overview"
        }
      }
    }
    ...
    "have a section on using this service" which {
      ...
      "has a fourth paragraph" which {
        ...
        "has the correct link location" in {
          element("#using-this-service > p:nth-of-type(4) > a").attr("href") shouldBe "https://mcmw.abilitynet.org.uk/"
        }
      }
    }
    ...
    "have a section on how accessible this service is" which {
      ...
      "has a first paragraph" which {
        ...
        "has the correct link location" in {
          element("#how-accessible > p:nth-of-type(1) > a").attr("href") shouldBe "https://www.w3.org/TR/WCAG21/"
        }
      }
    ...
    "have a section on responding to complaints" which {
      ...
      "has a paragraph" which {
        ...
        "has the correct link location for the first link" in {
          element("#complaints > p > a:nth-of-type(1)").attr("href") shouldBe "https://www.equalityadvisoryservice.com/"
        }
        ...
        "has the correct link location for the second link" in {
          element("#complaints > p > a:nth-of-type(2)").attr("href") shouldBe "https://www.equalityni.org/Home"
        }
      }
    }
    ...
    "have a section on contacting HMRC" which {
      ...
      "has a third paragraph" which {
        ...
        "has the correct link location" in {
          element("#contact-us > p:nth-of-type(3) > a").attr("href") shouldBe "https://www.gov.uk/dealing-hmrc-additional-needs/deaf-hearing-impaired"
        }
      }
    }
    ...
    "have a section on technical information" which {
      ...
      "has the correct second paragraph" which {
        ...
        "has the correct link location" in {
          element("#technical-information > p:nth-of-type(2) > a").attr("href") shouldBe "https://www.w3.org/TR/WCAG21/"
        }
      }
    }
    ...
    "have a section on how we tested this service" which {
      ...
      "has a second paragraph" which {
        ...
        "has the correct link location" in {
          element("#how-we-tested > p:nth-of-type(2) > a").attr("href") shouldBe "http://www.digitalaccessibilitycentre.org/"
        }
      }
